...
class ConvBnAct(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, kernel, stride, dilation=1, bias=False, act=True):
        super(ConvBnAct, self).__init__()
        self.conv = nn.Conv2d(in_channel, out_channel, kernel, stride, padding=dilation, dilation=dilation, bias=bias)
...
class ResidualUBlock7(nn.Module):
    ...
    def __init__(self, in_channel, mid_channel, out_channel) -> None:
        ...
        self.input_conv = ConvBnAct(in_channel, out_channel, 3, 1, 1)

        self.encoder1_conv = ConvBnAct(out_channel, mid_channel, 3, 1, 1)
        ...
        self.decoder1_conv = ConvBnAct(2 * mid_channel, out_channel, 3, 1, 1)
